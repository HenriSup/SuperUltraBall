class PlayerBehavior extends Sup.Behavior {
  ...
  testTouches(){
    var test = this.hitBoxPunch.getTouches();
    var test2 = Sup.ArcadePhysics2D.intersects(this.hitBoxPunch,Sup.getActor("arcadeTest").arcadeBody2D);
    //Sup.getActor("ab2dTouches").textRenderer.setText("t:"+test.top+"\nb:"+test.bottom+"\nl:"+test.left+"\nr:"+test.right);
    Sup.getActor("ab2dTouches").textRenderer.setText(test2.toString());
